...
export const createAction = async (project, framework) => {
    ...
    await promisify(down)(getTemplateUrl(framework), project, { clone: true })
...
function getTemplateUrl(framework) {
    const frameworks = {
        'vue2': 'github:my-csl/vue2-template',
        'vue3': 'github:my-csl/vue3-standard-template',
        'uniapp': ''
    }
